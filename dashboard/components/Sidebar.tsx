...
function NavLink({ href, label, active }: { href: string; label: string; active: boolean }) {
  ...
  return (
    <Link
      ...
      style={{
        backgroundColor: active ? "var(--active-bg)" : hovered ? "var(--hover-overlay)" : "transparent",
  ...
  return (
    ...
    >
      ...
      <div className="px-3 pb-3 space-y-1">
        <NavLink href="/about" label="A propos" active={pathname === "/about"} />
        <a
          ...
          style={{
            color: ghHovered ? "var(--text)" : "var(--text-muted)",
            borderLeft: "3px solid transparent",
            backgroundColor: ghHovered ? "var(--hover-overlay)" : "transparent",
          }}
